            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="p-10 bg-white/5 border border-white/10 rounded-[40px] flex flex-col items-center text-center">
                        ...
                        <p className="text-slate-500 text-sm mb-10 italic">"Para fundadores que empiezan hoy"</p>
                        ...
                        <a href="https://app.soursop-ia.com/register" className="w-full py-4 rounded-2xl border border-white/10 hover:bg-white/5 text-white font-bold transition-all mt-auto flex items-center justify-center">
                            Comenzar Gratis
                        </a>
                    </div>
                    ...
                    <div className="p-10 bg-gradient-to-br from-emerald-500/20 to-blue-500/20 border-2 border-emerald-500/50 rounded-[40px] flex flex-col items-center text-center relative scale-105 shadow-2xl shadow-emerald-500/10">
                        ...
                        <p className="text-slate-300 text-sm mb-10 italic font-medium">"Alto rendimiento para empresas en crecimiento"</p>
                        ...
                        <a href="https://app.soursop-ia.com/register" className="w-full py-4 rounded-2xl bg-emerald-500 hover:bg-emerald-600 text-white font-bold transition-all shadow-lg shadow-emerald-500/20 mt-auto flex items-center justify-center">
                            Empezar Scale
                        </a>
                    </div>
